        ...
        try {
            ...
            if ($action === 'ticket') {
                ...
                responderJsonDevoluciones(
                    true,
                    $tieneTicket
                        ? 'Devolución marcada como retirada. Ya no aparta existencias para Resurtidos ni Tickets.'
                        : 'Se quitó la marca. Las piezas vuelven a quedar apartadas para devolución.',
                    [
                        'registro' => $registro,
                    ]
                );
    ...
    <section class="devolucion-card tabla-card">
        <div class="tabla-encabezado">
            <div>
                ...
                <p>
                    Las devoluciones sin palomita apartan existencias. Las
                    filas amarillas ya fueron retiradas del sistema y dejan
                    de descontarse en Resurtidos y Tickets.
                </p>
            </div>
